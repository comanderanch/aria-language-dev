...
# Round 10: CosineAnnealingWarmRestarts — T_0=500, T_mult=2
...
if args.cont:
    ...
    print(f"  Round 10 — {args.epochs} epochs — target loss {args.target}")
    print()
...
for epoch in range(1, EPOCHS + 1):
    ...
    if metrics["loss"] < best:
        ...
        torch.save({
            ...
            "note":        "word-level checkpoint — Round 10"
...
torch.save({
    ...
    "epoch":       EPOCHS,
    "vocab":       "word_level_547",
    "note":        "word-level final state — Round 10"
}, word_checkpoint_path)
...
print("═" * 60)
print()
print(f"Round 10 {'continued' if args.cont else 'complete'}.")
