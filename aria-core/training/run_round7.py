#!/usr/bin/env python3
# ARIA ROUND 7 — EXPANDED VOCABULARY RETRAIN
# March 17 2026 — Haskell Texas
#
# Round 5: 216 words — 46% UNK rate — loss floor ~3.05
# Round 7: 314 words — 26.8% UNK rate — target: break 2.40
#
...
print("║  314 words. 26.8% UNK. Target: beat 2.40.    ║")
...
if args.cont:
    ...
    print(f"  Round 7 — {args.epochs} epochs — target loss {args.target}")
    print()
...
for epoch in range(1, EPOCHS + 1):
    ...
    if metrics["loss"] < best:
        ...
        _torch.save({
            ...
            "best_loss":   best,
            "epoch":       epoch,
            "vocab":       "word_level_314",
            "note":        "word-level checkpoint — Round 7"
...
torch.save({
    ...
    "epoch":       EPOCHS,
    "vocab":       "word_level_314",
    "note":        "word-level final state — Round 7"
}, word_checkpoint_path)
